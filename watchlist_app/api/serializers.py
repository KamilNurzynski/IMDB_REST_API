...
class ReviewSerializer(serializers.ModelSerializer):
    author = serializers.StringRelatedField(read_only=True) # używa __str__ z klasy
...
class WatchListSerializer(serializers.ModelSerializer):
    ...
    stream_platform = serializers.CharField(source='stream_platform.name') # w ten sposób używamy nazwy a nie id
