...
urlpatterns = [
    ...
    path('stream_platform/<int:pk>/review_create/', views.ReviewCreate.as_view(), name='review_create'),
    path('stream_platform/<int:pk>/review/', views.ReviewList.as_view(), name='review_list'),
    path('stream_platform/review/<int:pk>/', views.ReviewDetail.as_view(), name='review_details'),
]
